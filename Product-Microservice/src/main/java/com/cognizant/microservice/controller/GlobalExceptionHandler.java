...
import org.springframework.web.bind.annotation.ExceptionHandler;
//import com.cognizant.truyum.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler 
{
	...
	{
		return new ErrorResponseDto(new Date(), HttpStatus.CONFLICT.value(), HttpStatus.CONFLICT.getReasonPhrase(), exception.getMessage(), request.getRequestURI());
	}
