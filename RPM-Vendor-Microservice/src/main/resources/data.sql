...
insert into vendor_stock (expected_stock_replinshment_date, stock_in_hand, vendor_id, product_id, id) values ('2021-11-01', 140, 2, 1, 2);
...
insert into vendor_stock (expected_stock_replinshment_date, stock_in_hand, vendor_id, product_id, id) values ('2020-11-01', 50, 1, 2, 4);
insert into vendor_stock (expected_stock_replinshment_date, stock_in_hand, vendor_id, product_id, id) values ('2021-11-01', 40, 2, 2, 5);